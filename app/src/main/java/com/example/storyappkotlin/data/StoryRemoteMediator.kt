...
import com.example.storyappkotlin.data.remote.dto.toEntityList
...
class StoryRemoteMediator(
    ...
    override suspend fun load(
        ...
        try {
            val responseData = apiService.getPagedStories(token, page, state.config.pageSize, location)
            ...
            database.withTransaction {
                ...
                database.storyDao().insertStory(responseData.listStory.toEntityList())
            }
